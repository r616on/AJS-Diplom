...
export default class GamePlay {
  ...
  drawUi(theme) {
    ...
    this.container.innerHTML = `
      ...
      <div class="prizeScore"> Текущий счет: 0 </div>
      <div class="finishScore"> Общий счет: 0 </div>
      </div>
    `;
    this.level = this.container.querySelector('.level');
    this.prizeScore = this.container.querySelector('.prizeScore');
    this.finishScore = this.container.querySelector('.finishScore');
